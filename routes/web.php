...
Route::post('/bukti-booking/{id}', [BookingController::class, 'buktiBK']);
...
Route::post('//delete-mobil/{id}', [DashboardController::class, 'deleteMobil']);
...
Route::post('/delete-konsumen/{id}', [DashboardController::class, 'deleteKonsumen']);
...
Route::post('/cetak/{id}', [DashboardController::class, 'cetak']);
